package registerandlogin.common;

public class Constants {

    public static final String APP_ID = "N7PGvsRfXvKpedyyRXSa6MJY7AsKbvVkviSsXJqumbz";
    public static final String SDK_KEY = "GcLfLZn3NjpJaHN2sQAg4sa6SdcAZKXZ4KMoR2KctSK4";
